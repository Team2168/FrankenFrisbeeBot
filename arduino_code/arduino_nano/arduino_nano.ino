...
sig_type signals[] = {                 //ENABLE SIGNAL MUST BE LAST!
  {.input_pin = 8,  .output_pin =  4}, //RX Ch1 - Shooter Speed
  {.input_pin = 9,  .output_pin =  2}, //RX Ch2 - Right DT Motor Speed
  {.input_pin = 10, .output_pin =  3}, //RX Ch3 - Left DT Motor Speed
  {.input_pin = 11, .output_pin =  5}, //RX Ch4 - Raise Solenoid
  {.input_pin = 12, .output_pin =  6}, //RX Ch5 - Fire Solenoid
  {.input_pin = 13, .output_pin = -1}  //RX Ch6 - Robot Enable/Disable (no output pin)
};
